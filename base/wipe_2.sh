...
[ "$dev1" ] && [ "$dev2" ] ||
	error_exit "One of the device variables have not been set in wipe_2.sh"
...
[ "$wipe_full_disk" = "true" ] &&
	printf "%s\n" \
	"This script is currently configured to wipe the entirety of ${dev1} and ${dev2}" \
	...
	printf "%s\n" \
	"This script is currently configured to wipe the first ${wipe_mib} MiB of ${dev1} and ${dev2}" \
